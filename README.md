# Docker Template
Template project, can be used for packing ML model in Docker container

This command allows you not to type "sudo" every time while using docker
```shell
...
This README taken from here: https://github.com/eon01/DockerCheatSheet/tree/master
